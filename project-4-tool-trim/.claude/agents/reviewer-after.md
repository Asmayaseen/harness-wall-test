---
name: reviewer-after
description: Fix the failing check in sample-repo, using the trimmed 4-tool allowlist. Used as the "after" arm of a before/after tool-trim comparison.
...
available to you: Bash, Read, Edit, Agent. Do not call any tool outside this list
